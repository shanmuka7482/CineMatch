...
function ContentCard({
  ...
  const handleClick = (movieVal) => {
    ...
    navigate(
      `/content?movieVal=${movieVal}&filterType=Select by category&filterVal=`
    );
  };
        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="!text-right">
              <button
                className="bg-teal-500 hover:bg-teal-600 text-white text-base tracking-wide px-6 py-3 rounded-lg transition duration-300 ease-in-out shadow-lg hover:shadow-xl w-fit"
