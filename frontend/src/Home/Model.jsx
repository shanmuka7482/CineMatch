...
const Model = ({ isOpen, onClose }) => {
    ...
    const search = async(e)=>{
      ...
      setMovieVal("")
      setFilterType("Select by category")
      SetFilterVal("")
    }
  ...
  return (
    <div>
      <div
        ...
        tabIndex="-1"
        aria-hidden="true"
        className={`${isOpen ? "" : "hidden"} overflow-y-auto overflow-x-hidden flex fixed top-0 right-0 left-0 z-50 justify-center items-center w-full h-full`}>
        <div className="relative p-4 w-full max-w-screen-lg max-h-screen-lg">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            {/* <!-- Modal body --> */}
            <form className="p-4 md:p-5" id="myForm">
              ...
              >
                ...
                <span className="px-3" onClick={search}>Search</span>
              </button>
            </form>
          </div>
        </div>
